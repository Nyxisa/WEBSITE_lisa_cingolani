    ...
    <article class="mb-10 margins lg:mt-8">
        ...
        <div>
            ...
            <div class="flex flex-col [&>*]:mb-4 [&>*:nth-child(odd)]:self-end md:[&>*:nth-child(odd)]:self-auto">
                ...
                <p class="about-text">{{ $t('about.p4') }}</p>
                <p class="about-text">{{ $t('about.p5') }}</p>
            </div>
        </div>
